...
and1= np.array([94, 294, 425, 566])
and2= np.array([225, 380, 475, 495])


app.layout = html.Div([
    html.Div([
        html.Div([
            html.H1(children='Magic Sigil Maker'),
    ], className = "row"),
    html.Div([
        dcc.Dropdown(
            id='my-dropdown',
    ...
    html.Div([
        ...
        html.Button('Brute Force', id='button-2', n_clicks = 0, style={'width': '10%', 'margin-left':300, 'text-align': 'center', 'color': '#de3d96'}, className='four columns'),
        html.Button('Results', id='button-3', n_clicks = 0, style={'width': '10%', 'margin-left':295, 'text-align': 'center', 'color': '#de3d96'}, className='four columns'),
    ], className='row'),
...
def on_click(mydropdown, input1, intermediatevalue):
    with open('magicsum.txt') as json_file:  
        magsum= json.load(json_file)
...
def style_table(interbtndecode, intermediatevalue, interinput, interslider, interdropd):
    ...
    if e <= 2:
        ...
        if zz == 'Andromeda' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([94, 294, 425, 566])
            hw2= np.array([225, 380, 475, 495])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Andromeda' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Antlia' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([15, 211, 533, 627])
            hw2= np.array([492, 266, 151, 438])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Antlia' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Aquarius' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([206, 232, 264, 334, 481])
            hw2= np.array([129, 127, 148, 132, 221])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Aquarius' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Aquila' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([83, 209, 391, 219, 526, 524])
            hw2= np.array([458, 403, 351, 190, 54, 570])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Aquila' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Aries' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([67, 157, 226, 522, 610, 623])
            hw2= np.array([466, 415, 232, 351, 428, 473])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Aries' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Auriga' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([176, 355, 416, 427, 493, 175])
            hw2= np.array([247, 211, 318, 253, 504, 434])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Auriga' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Bootes' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([219, 359, 363, 557, 293, 137])
            hw2= np.array([49, 103, 294, 464, 375, 214])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Bootes' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Caelum' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([126, 362, 374, 461])
            hw2= np.array([90, 172, 415, 576])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Caelum' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Cancer' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([261, 277, 264, 161, 479])
            hw2= np.array([27, 243, 342, 532, 613])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Cancer' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Cane' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([569, 371])
            hw2= np.array([306, 460])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Cane' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Major' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([120, 216, 248, 366, 522, 278, 527])
            hw2= np.array([538, 443, 369, 157, 198, 517, 555])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Major' and slider == 2:
            df = np.flip(bc, 1)
            df = np.roll(df, neg1, axis=1)
            hw1= np.array([120, 216, 248, 366, 522, 278, 527])
            hw2= np.array([538, 443, 369, 157, 198, 517, 555])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Major' and slider == 3:
            bd = np.rot90(bc, 2)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([120, 216, 248, 366, 522, 278, 527])
            hw2= np.array([538, 443, 369, 157, 198, 517, 555])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)            
        if zz == 'Canis Major' and slider == 4:
            bd = np.flip(bc, 0)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([120, 216, 248, 366, 522, 278, 527])
            hw2= np.array([538, 443, 369, 157, 198, 517, 555])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Canis Major' and slider == 5:
            bd = np.rot90(bc, 3)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([120, 216, 248, 366, 522, 278, 527])
            hw2= np.array([538, 443, 369, 157, 198, 517, 555])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Canis Major' and slider == 6:
            bd = np.rot90(bc, 1)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([120, 216, 248, 366, 522, 278, 527])
            hw2= np.array([538, 443, 369, 157, 198, 517, 555])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Major' and slider == 7:
            bd = np.rot90(bc, 1)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([120, 216, 248, 366, 522, 278, 527])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Major' and slider == 8:
            bd = np.rot90(bc, 3)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([120, 216, 248, 366, 522, 278, 527])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Minor' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([292, 466])
            hw2= np.array([442, 251])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Minor' and slider == 2:
            df = np.flip(bc, 1)
            df = np.roll(df, neg1, axis=1)
            hw1= np.array([292, 466])
            hw2= np.array([442, 251])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Minor' and slider == 3:
            bd = np.rot90(bc, 2)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([292, 466])
            hw2= np.array([442, 251])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)            
        if zz == 'Canis Minor' and slider == 4:
            bd = np.flip(bc, 0)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([292, 466])
            hw2= np.array([442, 251])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Canis Minor' and slider == 5:
            bd = np.rot90(bc, 3)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([292, 466])
            hw2= np.array([442, 251])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Canis Minor' and slider == 6:
            bd = np.rot90(bc, 1)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([292, 466])
            hw2= np.array([442, 251])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Minor' and slider == 7:
            bd = np.rot90(bc, 1)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([292, 466])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Canis Minor' and slider == 8:
            bd = np.rot90(bc, 3)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([292, 466])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Columba' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([53, 129, 323, 388, 331, 500, 587])
            hw2= np.array([105, 186, 170, 191, 550, 103, 176])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Columba' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Coma-Berenices' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([64, 50, 480])
            hw2= np.array([568, 100, 74])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Coma-Berenices' and slider == 2:
            df = np.flip(bc, 1)
            df = np.roll(df, neg1, axis=1)
            hw1= np.array([64, 50, 480])
            hw2= np.array([568, 100, 74])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Coma-Berenices' and slider == 3:
            bd = np.rot90(bc, 2)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([64, 50, 480])
            hw2= np.array([568, 100, 74])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)            
        if zz == 'Coma-Berenices' and slider == 4:
            bd = np.flip(bc, 0)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([64, 50, 480])
            hw2= np.array([568, 100, 74])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Coma-Berenices' and slider == 5:
            bd = np.rot90(bc, 3)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([64, 50, 480])
            hw2= np.array([568, 100, 74])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Coma-Berenices' and slider == 6:
            bd = np.rot90(bc, 1)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([64, 50, 480])
            hw2= np.array([568, 100, 74])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Coma-Berenices' and slider == 7:
            bd = np.rot90(bc, 1)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([64, 50, 480])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Coma-Berenices' and slider == 8:
            bd = np.rot90(bc, 3)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([64, 50, 480])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Australis' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([343, 187, 137, 135, 173, 270, 525])
            hw2= np.array([27, 34, 117, 258, 360, 511, 630])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Australis' and slider == 2:
            df = np.flip(bc, 1)
            df = np.roll(df, neg1, axis=1)
            hw1= np.array([343, 187, 137, 135, 173, 270, 525])
            hw2= np.array([27, 34, 117, 258, 360, 511, 630])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Australis' and slider == 3:
            bd = np.rot90(bc, 2)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([343, 187, 137, 135, 173, 270, 525])
            hw2= np.array([27, 34, 117, 258, 360, 511, 630])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)            
        if zz == 'Corona-Australis' and slider == 4:
            bd = np.flip(bc, 0)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([343, 187, 137, 135, 173, 270, 525])
            hw2= np.array([27, 34, 117, 258, 360, 511, 630])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Corona-Australis' and slider == 5:
            bd = np.rot90(bc, 3)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([343, 187, 137, 135, 173, 270, 525])
            hw2= np.array([27, 34, 117, 258, 360, 511, 630])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Corona-Australis' and slider == 6:
            bd = np.rot90(bc, 1)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([343, 187, 137, 135, 173, 270, 525])
            hw2= np.array([27, 34, 117, 258, 360, 511, 630])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Australis' and slider == 7:
            bd = np.rot90(bc, 1)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([343, 187, 137, 135, 173, 270, 525])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Australis' and slider == 8:
            bd = np.rot90(bc, 3)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([343, 187, 137, 135, 173, 270, 525])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Borealis' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([188, 286, 372, 438, 532, 588, 530])
            hw2= np.array([367, 505, 541, 528, 503, 373, 272])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Borealis' and slider == 2:
            df = np.flip(bc, 1)
            df = np.roll(df, neg1, axis=1)
            hw1= np.array([188, 286, 372, 438, 532, 588, 530])
            hw2= np.array([367, 505, 541, 528, 503, 373, 272])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Borealis' and slider == 3:
            bd = np.rot90(bc, 2)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([188, 286, 372, 438, 532, 588, 530])
            hw2= np.array([367, 505, 541, 528, 503, 373, 272])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)            
        if zz == 'Corona-Borealis' and slider == 4:
            bd = np.flip(bc, 0)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([188, 286, 372, 438, 532, 588, 530])
            hw2= np.array([367, 505, 541, 528, 503, 373, 272])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Corona-Borealis' and slider == 5:
            bd = np.rot90(bc, 3)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([188, 286, 372, 438, 532, 588, 530])
            hw2= np.array([367, 505, 541, 528, 503, 373, 272])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Corona-Borealis' and slider == 6:
            bd = np.rot90(bc, 1)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([188, 286, 372, 438, 532, 588, 530])
            hw2= np.array([367, 505, 541, 528, 503, 373, 272])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Borealis' and slider == 7:
            bd = np.rot90(bc, 1)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([188, 286, 372, 438, 532, 588, 530])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corona-Borealis' and slider == 8:
            bd = np.rot90(bc, 3)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([188, 286, 372, 438, 532, 588, 530])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Corvus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([190, 410, 491, 508, 123])
            hw2= np.array([60, 131, 462, 588, 493])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Corvus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Capricornus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([28, 74, 192, 298, 596, 618, 423, 384, 288, 176, 152, 98])
            hw2= np.array([221, 238, 239, 248, 187, 126, 474, 518, 461, 393, 377, 313])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Capricornus' and slider == 2:
            df = np.flip(bc, 1)
            df = np.roll(df, neg1, axis=1)
            hw1= np.array([28, 74, 192, 298, 596, 618, 423, 384, 288, 176, 152, 98])
            hw2= np.array([221, 238, 239, 248, 187, 126, 474, 518, 461, 393, 377, 313])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Capricornus' and slider == 3:
            bd = np.rot90(bc, 2)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([28, 74, 192, 298, 596, 618, 423, 384, 288, 176, 152, 98])
            hw2= np.array([221, 238, 239, 248, 187, 126, 474, 518, 461, 393, 377, 313])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)            
        if zz == 'Capricornus' and slider == 4:
            bd = np.flip(bc, 0)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([28, 74, 192, 298, 596, 618, 423, 384, 288, 176, 152, 98])
            hw2= np.array([221, 238, 239, 248, 187, 126, 474, 518, 461, 393, 377, 313])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Capricornus' and slider == 5:
            bd = np.rot90(bc, 3)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([28, 74, 192, 298, 596, 618, 423, 384, 288, 176, 152, 98])
            hw2= np.array([221, 238, 239, 248, 187, 126, 474, 518, 461, 393, 377, 313])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)   
        if zz == 'Capricornus' and slider == 6:
            bd = np.rot90(bc, 1)
            df = np.roll(bd, neg1, axis=1)
            hw1= np.array([28, 74, 192, 298, 596, 618, 423, 384, 288, 176, 152, 98])
            hw2= np.array([221, 238, 239, 248, 187, 126, 474, 518, 461, 393, 377, 313])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Capricornus' and slider == 7:
            bd = np.rot90(bc, 1)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([28, 74, 192, 298, 596, 618, 423, 384, 288, 176, 152, 98])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Capricornus' and slider == 8:
            bd = np.rot90(bc, 3)
            be = np.flip(bd, 1)
            df = np.roll(be, neg1, axis=1)
            hw1= np.array([28, 74, 192, 298, 596, 618, 423, 384, 288, 176, 152, 98])
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Centaurus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([55, 69, 138, 104, 31, 179, 236, 295, 329, 239, 239, 225, 271, 153, 220, 424, 411, 424, 454, 501, 487, 590, 494, 500])
            hw2= np.array([119, 161, 151, 227, 241, 121, 86, 166, 121, 204, 215, 292, 393, 524, 503, 330, 186, 330, 356, 375, 401, 478, 556, 592])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Centaurus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Cetus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([52, 120, 133, 204, 295 , 385, 437, 514, 598, 320, 295])
            hw2= np.array([185, 197, 238,  280,  377,  348,  376,  484,  363, 451, 377])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Cetus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Crater' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw0= np.array([216, 350, 409, 619, 480, 347, 133, 14])
            hw2= np.array([19, 73, 250, 423, 624, 384, 413, 365])
            hw1 = hw0//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Crater' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Cygnus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([230, 303, 419, 555, 436, 205, 83])
            hw2= np.array([270, 370, 469, 603, 257, 499, 570])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Cygnus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Delphinus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([132, 337, 404, 548, 238])
            hw2= np.array([70, 79, 220, 601, 179])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Delphinus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Equuleus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([245, 488, 173])
            hw2= np.array([55, 30, 596])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Equuleus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Grus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([76, 64, 257, 473, 176, 237, 326, 423, 483, 579])
            hw2= np.array([287, 350, 384, 371, 610, 546, 266, 172, 102, 26])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Grus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Eridanus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([157, 158, 196, 213, 236, 295, 323, 354, 360, 386, 476, 486, 468, 439, 403, 374, 344, 314, 243, 238, 261, 273, 326, 325, 344, 370, 414, 446, 438, 444, 446, 475, 471])
            hw2= np.array([104, 66, 70, 47, 47, 83, 147, 138, 114, 114, 118, 218, 238, 259, 235, 231, 242, 247, 298, 305, 340, 335, 363, 375, 403, 435, 417, 422, 450, 503, 544, 559, 623])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Eridanus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Fornax' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([21, 227, 625])
            hw2= np.array([263, 404, 303])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Fornax' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Gemini' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([45, 175, 275, 434, 557, 606, 526, 476, 440, 433, 314, 217, 74, 80, 90])
            hw2= np.array([102, 106, 150, 280, 339, 338, 401, 503, 583, 595, 399, 359, 292, 200, 177])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Gemini' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Hercules' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([35, 121, 197, 232, 271, 324, 382, 434, 388, 252, 319, 488, 513, 582, 501, 552, 584])
            hw2= np.array([446, 437, 334, 330, 360, 390, 411, 313, 218, 201, 60, 180, 122, 72, 299, 462, 499])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Hercules' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Hydra' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([36, 110, 251, 279, 354, 391, 422, 431, 455, 503, 487, 538, 580, 603, 613, 614, 599])
            hw2= np.array([435, 392, 452, 438, 330, 340, 312, 316, 333, 293, 234, 212, 187, 211, 211, 194, 184])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Hydra' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Lacerta' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([327, 375, 371, 339, 334, 459])
            hw2= np.array([104, 24, 134, 215, 403, 620])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Lacerta' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Leo Minor' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([20, 228, 380, 627])
            hw2= np.array([310, 241, 295, 244])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Leo Minor' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Leo' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([610, 575, 476, 461, 217, 48, 519])
            hw2= np.array([80, 38, 95, 164, 145, 251, 315])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Leo' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Lepus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([222, 461, 534, 276])
            hw2= np.array([338, 273, 579, 489])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Lepus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Libra' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([140, 167, 258, 358, 381, 493])
            hw2= np.array([285, 334, 290, 173, 398, 320])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Libra' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)
        if zz == 'Lupus' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([125, 291, 297, 411, 485, 339, 342, 289, 223, 87, 49])
            hw2= np.array([120, 181, 306, 375, 499, 619, 539, 416, 319, 260, 220])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
        ...
        if zz == 'Lupus' and slider == 8:
            ...
            gs=gs.render()
            return dash_dangerously_set_inner_html.DangerouslySetInnerHTML(gs)            
        if zz == 'Lynx' and slider == 1:
            df = np.roll(bc, neg1, axis=1)
            hw1= np.array([61, 74, 160, 308, 497, 532, 626])
            hw2= np.array([621, 572, 476, 449, 293, 74, 17])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
            hw2[hw2 == e] = (e-1)
...
def func(intermediatevalue, interinput, interdropd, interslider, interbtndecode):
    ...
    with open('magic.txt') as json_file:  
        ...
        magic_square2 = np.array(magic_square)
        if zz == 'Andromeda' and z3 == 1:
            l = (magic_square2 % 26)
            l[l == 0] = 26
            k = []
            why = and1//s
        ...
        if zz == 'Coma-Berenices' and z3 == 8:
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Australis' and z3 == 1:
            bc = np.array(magic_square)
            l = (bc % 26)
            l[l == 0] = 26
            k = []
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Australis' and z3 == 2:
            bc = np.array(magic_square)
            bd = np.flip(bc, 1)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Australis' and z3 == 3:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 2)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Australis' and z3 == 4:
            bc = np.array(magic_square)
            bd = np.flip(bc, 0)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Australis' and z3 == 5:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 3)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Australis' and z3 == 6:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 1)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Australis' and z3 == 7:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 1)
            be = np.flip(bd, 1)
            l = (be % 26)
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Australis' and z3 == 8:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 3)
            be = np.flip(bd, 1)
            l = (be % 26)
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Borealis' and z3 == 1:
            bc = np.array(magic_square)
            l = (bc % 26)
            l[l == 0] = 26
            k = []
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Borealis' and z3 == 2:
            bc = np.array(magic_square)
            bd = np.flip(bc, 1)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Borealis' and z3 == 3:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 2)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Borealis' and z3 == 4:
            bc = np.array(magic_square)
            bd = np.flip(bc, 0)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Borealis' and z3 == 5:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 3)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Borealis' and z3 == 6:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 1)
            l = (bd % 26)
            l[l == 0] = 26
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Borealis' and z3 == 7:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 1)
            be = np.flip(bd, 1)
            l = (be % 26)
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Corona-Borealis' and z3 == 8:
            bc = np.array(magic_square)
            bd = np.rot90(bc, 3)
            be = np.flip(bd, 1)
            l = (be % 26)
        ...
        if zz == 'Cetus' and z3 == 8:
            ...
            if z5 <= 0 and mk == 2:
                ...
                with open('het.txt', 'w') as outfile:
                    return json.dump(s, outfile)
        if zz == 'Crater' and z3 == 1:
            bc = np.array(magic_square)
            l = (bc % 26)
            l[l == 0] = 26
            k = []
            hw1= np.array([216, 350, 409, 619, 480, 347, 133, 14])
            hw2= np.array([19, 73, 250, 423, 624, 384, 413, 365])
            hw1 = hw1//s
            hw2 = hw2//s
            hw1[hw1 == e] = (e-1)
    ...
    if button2 >= 1:
        with open('het.txt') as json_file:  
            ...
            if xox == 4:
                ...
                x = list(zip(q, xy))
                merged1 = list(itertools.chain(*x))
                y = nd.array(merged1).reshape(f, 8)
                h = [(''.join(i)) for i in y]
                h = str(h)
                with open('box2.txt', 'w', encoding="utf-8") as outfile:
                    return json.dump(h, outfile)
                ...
                x = list(zip(q, xy))
                merged1 = list(itertools.chain(*x))
                y = nd.array(merged1).reshape(f, 9)
                h = [(''.join(i)) for i in y]
                h = str(h)
                with open('box2.txt', 'w', encoding="utf-8") as outfile:
                    return json.dump(h, outfile)
